$(document).ready(function() {
  ...
  } ,
  {
    ...
    name:"Actions",
    render:function(data, type, row, meta){
      return '<a class="insbutton fa fa-plus-square btn btn-success" href="#"></a>';
    },
    dsiabled:true
  }
  ];
  ...
  // Insert / 수락 버튼 기능 넣어야됨 /
  $(document).on('click', "[id^='example'] .insbutton", 'tr', function (x){
